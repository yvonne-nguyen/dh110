...
<iframe width="1000" height="600" src="https://www.youtube.com/embed/CQApcNAEHhI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
Overally, I had a lot of fun doing this project. I got to learn about steps that go behind the UX Design process and I learned how to use Figma. Learning about UX Design taught me to be more appreciative about the features that are a apart of every app/website. Overall, I'm surprised by the amount of work I've managed to complete within just a short span of time (~10 weeks). UX Design is an interesting field and I’m eager to learn more about it. I’m grateful that UCLA offers a course on UX Design and taking this course made me feel more confident about pursuing my own projects.
